    ...
    <nav class="navbar navbar-expand-lg fixed-top navbar-dark bg-dark">
        <div class="container-fluid ">
            ...
            <div class="collapse navbar-collapse " id="navbarSupportedContent">
                ...
                &emsp;
                <button type="button" class="btn btn-danger"><a href="{{route('showuserlogin')}}" class="fontcolorlogin">Login</a></button>
                &emsp;&emsp;
                <button type="button" class="btn btn-danger "><a href="{{route('showuserregister')}}" class="fontcolorlogin">Register</a></button>
            </div>
        </div>
    </nav>
    <!-- END Navbar -->
        ...
        <div id="carouselExampleRide" class="carousel slide carousel-fade" data-bs-ride="true">
            ...
            <div class="carousel-inner">
                <div class="carousel-item  active">
                    <img src="{{asset('user/img/cr1.jpg')}}" class="d-block w-100" alt="..."
                ...
                <div class="carousel-item">
                    <img src="{{asset('user/img/cr2.jpg')}}" class="d-block w-100  " alt="..."
                        style="height: 550px; width: 100%; opacity: 0.8;">
                    <div class="carousel-caption d-none d-md-block">
                ...
                <div class="carousel-item">
                    <img src="{{asset('user/img/cr3.jpg')}}" class="d-block w-100" alt="..."
                        style="height: 550px; width: 100%; opacity: 0.8;">
                    <div class="carousel-caption d-none d-md-block">
            ...
            <div class="col-md-6 ">
                <div
                    ...
                    <div class="col-auto d-lg-md-sm-block  ">
                        <img src="{{asset('user/img/lumbani1.jpg')}}" alt="" class="bd-placeholder-img" width="200" height="270">
                    </div>
                </div>
            </div>
            <div class="col-md-6 ">
                <div
                    ...
                    <div class="col-auto d-lg-md-sm-block  ">
                        <img src="{{asset('user/img/ktm.jpg')}}" alt="" class="bd-placeholder-img" width="200" height="270">
                    </div>
                </div>
            </div>
            <div class="col-md-6 ">
        ...
        <footer class="py-5">
            <div class="row">
                <div class="col-4 col-md-4 mb-3">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-body-secondary">Team Features</a></li>
                ...
                <div class="col-4 col-md-4 mb-3">
                    ...
                    <ul class="nav flex-column">
                        <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-body-secondary">Home</a></li>
                        <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-body-secondary">Resources</a>
                        </li>
                        <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-body-secondary">Resources
                                name</a></li>
                ...
                <div class="col-4 col-md-4 mb-3">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-body-secondary">Location</a></li>
            ...
            <div class="d-flex flex-column flex-sm-row justify-content-between py-4 my-4 border-top">
                ...
                <ul class="list-unstyled d-flex">
                    <li class="ms-3"><a class="link-body-emphasis" href="#"><img href="cr1.jpg" class="bi" width="24"
                                height="24 ">
